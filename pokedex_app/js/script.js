let pokemonRepository = (function() {
    ...
    function showModal(title, text, image) {
        ...
        modalBodyElement.innerHTML = `<p>${text}</p><img src="${image}" alt="Image of the selected Pokemon" width="200" height="200">`;
    ...
    function showDetails(pokemon) {
        loadDetails(pokemon).then(function (updatedPokemon) {
            showModal(updatedPokemon.name, `Height: ${updatedPokemon.height}`, updatedPokemon.imageUrl, `Type: ${updatedPokemon.types}`);
            $('#pokemonModal').modal('show');
